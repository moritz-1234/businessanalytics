...
\begin{document}
\includepdf{content/titlePage.pdf}
...
\listoftables
\addcontentsline{toc}{chapter}{\listtablename} %Tabellenverzeichnis in table of content

\printacronyms[heading=chapter*,name=List of abbreviations] 
\addcontentsline{toc}{chapter}{List of abbreviations}%abkürzungsverzeichnis in table of content
