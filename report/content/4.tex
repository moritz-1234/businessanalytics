...
Given the data set's sampling of data up to 2017, both of the \ac{vw} Golfs in \autoref{mileage_data_new_car} have been first registered very recently,
...
Among the essential specifications of a vehicle is its power, measured in horsepower.
...
As with new vehicles, this relationship also manifests in the pre-owned market with a correlation of 0.465.
\subsection{Outliers}
...
\par
Overall, there is a clear trend observable that in par with the registration year, the width increases,
